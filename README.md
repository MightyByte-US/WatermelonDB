...
This fork includes encryption support via SQLCipher, based on an open pull request ([#1635](https://github.com/Nozbe/WatermelonDB/pull/1635)) by [@ororsatti](https://github.com/ororsatti).
